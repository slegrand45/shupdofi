...
val get_directories_ok : Srv.t -> (Com.Directory.relative Com.Directory.t * Com.Directory.relative Com.Directory.t option) list
val get_directories_ko : Srv.t -> Com.Directory.relative Com.Directory.t list
val get_paths_ok : Srv.t -> (Com.Directory.relative Com.Path.t * Com.Directory.relative Com.Path.t option) list
